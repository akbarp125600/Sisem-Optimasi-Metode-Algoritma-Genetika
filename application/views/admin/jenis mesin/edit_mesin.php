        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <?php echo form_open_multipart("mesin/edit_mesin"); ?>
              <?php echo validation_errors(); ?>
                <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="id">ID</label>
                    <input type="number" name="id" class="form-control" id="id" value="<?php echo $mesin['id'] ?>" readonly>
                  </div>
                  <div class="form-group">
                    <label for="nama">Nama</label>
                    <input type="text" name="nama" class="form-control" id="nama" value="<?php echo $mesin['nama'] ?>" placeholder="Material">
                  </div>
                  <div class="form-group">
