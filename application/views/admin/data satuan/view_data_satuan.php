...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
                 ...
                 <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php 
                      $no = 1;
                      foreach($data_satuan as $u){ 
                        ?>
                        <tr>
                          <td><?php echo $no++ ?></td>
                          <td><?php echo $u->id_satuan ?></td>
                          <td><?php echo $u->nama_satuan ?></td>
                          <td><?php echo $u->keterangan ?></td>
                          <?php if($this->session->userdata('level') == "admin"){ ?>
                            <td>
                              <!-- <button class="btn btn-outline-primary"><i class="fas fa-edit"></i><?php echo anchor('mesin/edit/'.$u->id_satuan,'Edit'); ?></button> -->
                              <button type="button" class="btn btn-outline-primary " data-toggle="modal" data-target="#modaledit<?php echo $u->id_satuan;?>"><i class="fas fa-trash-alt">edit</i></button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <?php echo form_open_multipart("satuan/tambah_data_satuan"); ?>
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              foreach ($idmax as $value) { ?>
                <input name="id_satuan" type="text" class="form-control" placeholder="Id" value="<?php echo $value['id_satuan']+$plus ?>" readonly>
              <?php } ?>  
            </div>
            <div class="form-group">
  ...
  foreach($data_satuan as $u){ 
    ?>
  <div class="modal fade" id="modaledit<?php echo $u->id_satuan;?>">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
       ...
       <!--  <?php echo form_open_multipart("satuan/edit_data_satuan"); ?>
        <?php echo validation_errors(); ?> -->
        <form action="<?php echo base_url('satuan/edit_data_satuan')?>" method="post">
          <div class="modal-body">
            <div class="form-group">
              <label for="id">ID</label>
             
                <input name="id_satuan" type="text" class="form-control" placeholder="Id" value="<?php echo $u->id_satuan ?>" readonly>
              
            </div>
            <div class="form-group">
              <label for="nama_jenis">Nama Jenis</label>
              <input type="text" name="nama_satuan" class="form-control" id="nama_jenis" value="<?php echo $u->nama_satuan ?>">
            </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <a href="<?php echo site_url('satuan/hapus_data_satuan/'.$u->id_satuan); ?>">
